...
public class PagingUtil {
    ...
    public static CommonDto setPageUtil(CommonForm commonForm) {
        ...
        pagination += "<a href='javascript:" + functionName + "(\"" + totalFirstPage + "\");' class=\"direction_left01\">[맨앞]</a>";
        pagination += "<a href='javascript:" + functionName + "(" + prePerPage + ");' class=\"direction_left01\">[이전]</a>";
        ...
        pagination += "<a href='javascript:" + functionName + "(" + nextPerPage + ");' class=\"direction_right01\">[다음]</a>";
        pagination += "<a href='javascript:" + functionName + "(" + totalLastPage + ");' class=\"direction_right01\">[맨뒤]</a>";
        pagination += "</div>";
